...
// ANSWER: The space complexity of countLetters is O(1) because the size of the letters object is constant, regardless of the input size. The splitStr array is created as a result of the input string, but it is not stored in memory for the entire execution of the function. The space complexity of countLettersRoundTwo is O(n) because the size of the letters object grows linearly with the size of the input string. The RegEx expression and the toLowerCase method create temporary strings in memory, but they are not stored in memory for the entire execution of the function.
